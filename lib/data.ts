...
export const services = [
  {
    ...
    title: "UI / UX Design",
    description:
      "User-centered design solutions — wireframes, prototypes, and polished interfaces that delight and convert.",
    icon: "monitor",
  },
  {
    num: "02",
  ...
  },
  {
    ...
    title: "Web Design",
    description:
      "Visually striking websites that reflect your brand and drive meaningful engagement with your audience.",
    icon: "globe",
  },
];
...
export const experiences = [
  {
    ...
    description:
      "Designing and developing web products for clients across various industries, from startups to established brands.",
  },
  {
    year: "2024 — Present",
    ...
    place: "Self-Employed · Remote",
    description:
      "Built responsive interfaces with React and contributed to design system development.",
  },
